...
public class IntegerSetTest {
	...
	public void testClear() {
		...
		assertTrue("when we check the clear of [5,7,8], the result should be []", set1.equals(set2));
	...
	public void testLength() {
		...
		assertEquals("when we check the length of [1, 5], the value is 2", set1.length(), 2);
	}
	...
	public void testEquals() {
		...
		assertFalse("when we check if [5,7] is equal to [], the result is False", set1.equals(set2));
		
		set2.add(5);
		set2.add(7);
		
		assertTrue("when we check if [5,7] is equal to [5, 7], the result is False", set1.equals(set2));
	}
	...
	public void testContains() {
		...
		assertTrue("when we check if 1 is contained in [1,2], then the value is True", set1.contains(1));
	...
	public void testLargest() throws IntegerSetException {
		...
		set1.add(5);
		set1.add(3);
		assertEquals("the smallest value in the set [7,5, 3] is 7", 7, set1.largest());
	...
	public void testSmallest() throws IntegerSetException {
		...
		set1.add(2);
		set1.add(3);
		assertEquals("the smallest value in the set [0,2,3] is 0", 0, set1.smallest());
	...
	public void testRemove() {
		...
		assertTrue("when 2 is removed from [1,2] is [1]", set2.equals(set1));
		
		IntegerSet set3 = new IntegerSet();
		
		set2.remove(1);
		
		assertTrue("when 1 is removed from [1], set is equal to []", set2.equals(set3));
	}
